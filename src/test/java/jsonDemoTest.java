...
public class jsonDemoTest {
    ...
    public void getfunction1() throws Exception {
        ...
        int statuscode = get("https://testerhome.com/api/v3/topics.json?limit=2&offset=0&type=last_actived").getStatusCode();
    ...
    public void postfunction1() throws Exception {
        ...
        int statuscode = given().param("grant_type", "password").and().param("username", "apitest@apitest.com")
    ...
    public void checkValue() throws Exception {
        ...
        get(response.jsonPath().getString("topics.id"));
